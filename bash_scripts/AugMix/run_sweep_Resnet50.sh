...
do
    ...
    --hparams """{\"batch_size\":64,\"val_augmentation\":true,\"consistency_loss_w\":12.0,\"normalization\":false,\"lr\":0.0001,\"resnet_dropout\":0.0,\"weight_decay\":0.0,\"resnet18\":false,\"empty_fc\":true,\"fixed_featurizer\":false}"""
done
