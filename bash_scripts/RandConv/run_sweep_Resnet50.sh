...
do
    ...
    --hparams """{\"batch_size\":64,\"lr\":0.0001,\"kernel_size\":0.0,\"consistency_loss_w\":10.0,\"resnet_dropout\":0.0,\"val_augmentation\":true,\"weight_decay\":0.0,\"resnet18\":false,\"empty_fc\":true,\"fixed_featurizer\":false}"""
done
