...
do
    ...
    --hparams """{\"num_blocks\":0,\"mixing\":false,\"clamp\":true,\"scheduler\":true,\"pre_epoch\":4,\"elbo_beta\":0.1,\"lr_adv\":0.00005,\"batch_size\":64,\"lr\":0.004,\"clw\":0.75,\"resnet_dropout\":0.0,\"weight_decay\":0.0,\"resnet18\":false,\"empty_fc\":true,\"fixed_featurizer\":false}"""
done
